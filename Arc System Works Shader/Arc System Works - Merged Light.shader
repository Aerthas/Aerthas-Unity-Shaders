...
Shader ".Aerthas/Arc System Works/Merged Light"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float smoothstepResult36 = smoothstep( 0.0 , ( _PrimaryShadowFuzziness * 0.01 ) , ( ( DefaultDot14 + ( 1.0 - ( _PrimaryShadowSize * 2.0 ) ) ) * VertexColorShading148 * ILMGShadowMaskPrimary116 ));
			...
			float smoothstepResult9 = smoothstep( 0.0 , ( _SecondaryShadowFuzziness * 0.01 ) , ( ( ( 1.0 - ( _SecondaryShadowSize * 2.0 ) ) + DefaultDot14 ) * ILMGShadowMaskSecondary357 ));
...
/*ASEBEGIN
Version=17700
-1611;121;1552;849;2915.694;-1249.42;1.96529;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;352;-3504.462,2404.304;Inherit;False;Property;_ILMGPrimaryScale;ILMG Primary Scale;29;0;Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-4198.122,681.5013;Inherit;False;Property;_SecondaryShadowFuzziness;Secondary Shadow Fuzziness;19;0;Create;True;0;0;False;0;0;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-3891.168,679.7921;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.01;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-3764.13,356.5492;Inherit;False;Property;_SecondaryShadowIntensity;Secondary Shadow Intensity;18;0;Create;True;0;0;False;0;0.9;0.9;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;268;-71.78204,1618.059;Inherit;False;Property;_EnableFresnelWORKINPROGRESS;Enable Fresnel (WORK IN PROGRESS);31;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=0F4A72A4086FDA93D4A77EB042AC122F9F3DF265
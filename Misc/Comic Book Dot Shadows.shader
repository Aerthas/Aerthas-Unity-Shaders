...
Shader ".Aerthas/Misc/Comic Book Dot Shadows"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 temp_cast_13 = ((( isGlobalLight8 > 0.0 ) ? ( ase_lightAtten * _RealShadowPush * dotResult16 ) :  ( dotResult77 * _FakeShadowPush ) )).xxxx;
			float4 lerpResult72 = lerp( ( _ShadowColor * float4( Albedo51 , 0.0 ) ) , float4( Albedo51 , 0.0 ) , step( tex2D( _DotTexture, ( (ase_screenPosNorm).xy * _Dotshadingdotscale ) ) , temp_cast_13 ).r);
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float4 lerpResult72 = lerp( ( _ShadowColor * float4( Albedo51 , 0.0 ) ) , float4( Albedo51 , 0.0 ) , step( tex2D( _DotTexture, ( (ase_screenPosNorm).xy * _Dotshadingdotscale ) ) , temp_cast_5 ).r);
			float4 clampResult96 = clamp( lerpResult72 , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
...
/*ASEBEGIN
Version=15401
104;68;1880;943;2146.1;56.31381;1;True;True
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;101;-1382.362,373.7903;Float;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;67;-1316.402,483.5191;Float;False;8;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=6A03157E2A62EB5DDAAEA399349C30C88469FC29
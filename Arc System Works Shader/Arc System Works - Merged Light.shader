...
Shader ".Aerthas/Arc System Works/Merged Light"
{
	...
	SubShader
	{
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float4 Diffuse183 = ( (( HasWorldLight87 > 0.0 ) ? ase_lightColor :  _FakeLightColor ) * tex2D( _Base, uv_Base182 ) * tex2DNode215 );
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 c = 0;
			float4 tex2DNode215 = tex2D( _Detail, i.uv2_texcoord2 );
			float4 DetailMask430 = tex2DNode215;
			...
			float4 FinalCustomLight202 = ( DetailMask430 * (( _EnableMetalMatcap )?( ( Diffuse183 * MetalMatCap111 ) ):( ( LightMultInformation158 * FinalLightDotProduct326 * Diffuse183 ) )) * ILMADiffuseMask118 );
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float4 FinalEmission427 = ( (( _EnableSpecularEmission )?( ( Diffuse183 * SpecularEmission412 ) ):( float4( 0,0,0,0 ) )) + Fresnel269 );
...
/*ASEBEGIN
Version=17700
2183;138;1920;849;3799.374;-823.6107;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;352;-3504.462,2404.304;Inherit;False;Property;_ILMGPrimaryScale;ILMG Primary Scale;29;0;Create;True;0;0;False;0;1;0.27;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;353;-3509.695,2630.82;Inherit;False;Property;_ILMGSecondaryScale;ILMG Secondary Scale;30;0;Create;True;0;0;False;0;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;42;-3649.39,-281.1504;Inherit;False;Property;_PrimaryShadowIntensity;Primary Shadow Intensity;15;0;Create;True;0;0;False;0;0.75;0.75;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;315;-3602.289,932.243;Inherit;False;Property;_SpecularIntensity;Specular Intensity;21;0;Create;True;0;0;False;0;0.5;3.14;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;245;-4659.132,2304.53;Inherit;False;1060.987;833.3728;Diffuse;10;183;184;220;215;182;216;218;217;219;430;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;184;-3975.42,2737.083;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;271;-1866.69,-1550.395;Inherit;False;1472.048;683.5941;;17;425;424;422;421;420;202;278;199;280;279;198;203;244;427;185;428;429;Finalize and combine all information;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;244;-1679.39,-1301.41;Inherit;False;183;Diffuse;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;280;-1380.999,-1278.552;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;430;-4002.596,2965.709;Inherit;False;DetailMask;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;429;-1135.576,-1477.458;Inherit;False;430;DetailMask;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;428;-967.3755,-1384.171;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;202;-817.8885,-1369.693;Inherit;False;FinalCustomLight;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;391;-1050.224,1714.982;Inherit;False;Property;_FresnelColor;Fresnel Color;36;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;270;772.1366,216.0683;Inherit;False;427;FinalEmission;1;0;OBJECT;;False;1;COLOR;0
...
WireConnection;428;1;278;0
WireConnection;428;2;185;0
...
ASEEND*/
//CHKSM=1B1BE6FA85333814E924A89210B076C020120516
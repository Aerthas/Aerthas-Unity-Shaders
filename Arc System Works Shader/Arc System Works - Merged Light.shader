...
Shader ".Aerthas/Arc System Works/Merged Light v6.7.6"
{
	...
	SubShader
	{
		...
		void outlineVertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float temp_output_32_0_g678 = _EnableCameraDistanceMult;
			float temp_output_33_0_g678 = _OutlineThickness;
			...
			float4 break8_g678 = VertexColors441;
			float3 ase_worldPos = mul( unity_ObjectToWorld, v.vertex );
			float outlineVar = (( temp_output_32_0_g678 > 0.0 ) ? ( 0.0001 * temp_output_33_0_g678 * break8_g678.a * min( ( break8_g678.g * distance( ase_worldPos , _WorldSpaceCameraPos ) ) , 1.0 ) * (( break8_g678.b > 0.1 ) ? 1.0 :  0.0 ) ) :  ( (( temp_output_32_0_g678 > 0.0 ) ? 0.0 :  5.0 ) * 1E-05 * temp_output_33_0_g678 * break8_g678.b * break8_g678.a ) );
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float4 temp_output_13_0_g678 = max( float4( 0,0,0,0 ) , ( 0.2 * Base183 ) );
			...
			#endif //aselc
			float clampResult128_g671 = clamp( ( (( abs( ase_worldlightDir ).x > float3( 0,0,0 ) ) ? 1.0 :  0.0 ) + (( ase_lightColor.a > 0.0 ) ? 1.0 :  0.0 ) ) , 0.0 , 1.0 );
			float4 temp_cast_3 = (_GlobalIntensityMinimum).xxxx;
			float4 clampResult123_g671 = clamp( (( (( _LightColor > 0.0 ) ? 0.0 :  clampResult128_g671 ) > 0.0 ) ? ase_lightColor :  ( _FakeLightColor * _FakeLightIntensity ) ) , temp_cast_3 , float4( 1,1,1,1 ) );
			float4 LightColorOut457 = clampResult123_g671;
			o.Emission = ( ( (( _EnableBaseColorMult > 0.0 ) ? ( temp_output_13_0_g678 * temp_output_13_0_g678 ) :  _OutlineColor ) * _OutlineColorIntensity ) * (( _EnableLightColorMult > 0.0 ) ? LightColorOut457 :  float4( 1,1,1,0 ) ) ).rgb;
		...
		float3 StereoCameraViewDirection152_g671( float3 worldPos )
		{
			#if UNITY_SINGLE_PASS_STEREO
			float3 cameraPos = float3((unity_StereoWorldSpaceCameraPos[0]+ unity_StereoWorldSpaceCameraPos[1])*.5); 
			#else
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 clampResult123_g671 = clamp( (( (( _LightColor > 0.0 ) ? 0.0 :  clampResult128_g671 ) > 0.0 ) ? ase_lightColor :  ( _FakeLightColor * _FakeLightIntensity ) ) , temp_cast_4 , float4( 1,1,1,1 ) );
			float4 LightColorOut457 = clampResult123_g671;
			...
			float4 temp_output_43_0_g675 = SSS2448;
			...
			float temp_output_106_0_g675 = DarkenHighlight538;
			float4 lerpResult122_g675 = lerp( temp_output_43_0_g675 , DarkHighlightColor1376 , temp_output_106_0_g675);
			float4 BaseSSS451 = ( temp_output_449_0 * _ShadowLayer1Intensity );
			float4 temp_output_42_0_g675 = BaseSSS451;
			float4 temp_output_41_0_g675 = Base183;
			...
			float4 temp_output_111_0_g675 = HighlightColor1381;
			...
			float temp_output_97_0_g675 = Highlight555;
			float4 lerpResult110_g675 = lerp( temp_output_41_0_g675 , temp_output_111_0_g675 , temp_output_97_0_g675);
			...
			float temp_output_191_0_g672 = radians( _ViewDirOffsetY );
			float cosY208_g672 = cos( temp_output_191_0_g672 );
			float temp_output_212_0_g672 = radians( _ViewDirOffsetZ );
			float cosZ214_g672 = cos( temp_output_212_0_g672 );
			float temp_output_192_0_g672 = radians( 0.0 );
			float cosX204_g672 = cos( temp_output_192_0_g672 );
			float sinZ213_g672 = sin( temp_output_212_0_g672 );
			float sinX201_g672 = sin( temp_output_192_0_g672 );
			float sinY207_g672 = sin( temp_output_191_0_g672 );
			float4 appendResult223_g672 = (float4(( cosY208_g672 * cosZ214_g672 ) , ( ( cosX204_g672 * sinZ213_g672 ) + ( sinX201_g672 * sinY207_g672 * cosZ214_g672 ) ) , ( ( sinX201_g672 * sinZ213_g672 ) - ( cosX204_g672 * sinY207_g672 * cosZ214_g672 ) ) , 0.0));
			float4 xAxis249_g672 = appendResult223_g672;
			float3 worldPos152_g671 = ase_worldPos;
			float3 localStereoCameraViewDirection152_g671 = StereoCameraViewDirection152_g671( worldPos152_g671 );
			float4 break195_g672 = float4( localStereoCameraViewDirection152_g671 , 0.0 );
			float4 temp_output_282_0_g672 = ( xAxis249_g672 * break195_g672.x );
			float4 appendResult224_g672 = (float4(( -cosY208_g672 * sinZ213_g672 ) , ( ( cosX204_g672 * cosZ214_g672 ) - ( sinX201_g672 * sinY207_g672 * sinZ213_g672 ) ) , ( ( sinX201_g672 * cosZ214_g672 ) + ( cosX204_g672 * sinY207_g672 * sinZ213_g672 ) ) , 0.0));
			float4 yAxis266_g672 = appendResult224_g672;
			float4 temp_output_285_0_g672 = ( yAxis266_g672 * break195_g672.y );
			float4 appendResult226_g672 = (float4(sinY207_g672 , ( -sinX201_g672 * cosY208_g672 ) , ( cosX204_g672 * cosY208_g672 ) , 0.0));
			float4 zAxis277_g672 = appendResult226_g672;
			float4 temp_output_287_0_g672 = ( zAxis277_g672 * break195_g672.z );
			float4 appendResult278_g672 = (float4(0.0 , 0.0 , 0.0 , 1.0));
			float4 wAxis279_g672 = appendResult278_g672;
			float4 temp_output_289_0_g672 = ( wAxis279_g672 * break195_g672.w );
			float4 normalizeResult291_g672 = normalize( ( temp_output_282_0_g672 + temp_output_285_0_g672 + temp_output_287_0_g672 + temp_output_289_0_g672 ) );
			float3 appendResult15_g673 = (float3(( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * sin( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 ) , sin( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) , ( cos( ( ( _FakeLightDirX / 180.0 ) * UNITY_PI ) ) * cos( ( ( _FakeLightDirY / 180.0 ) * UNITY_PI ) ) * -1.0 )));
			float3 normalizeResult2_g673 = normalize( appendResult15_g673 );
			float3 ase_normWorldNormal = normalize( ase_worldNormal );
			float dotResult28_g671 = dot( (( (( _LightDirection > 0.0 ) ? 0.0 :  clampResult128_g671 ) > 0.0 ) ? float4( ase_worldlightDir , 0.0 ) :  (( _FakeLightFallbackDirection > 0.0 ) ? normalizeResult291_g672 :  float4( normalizeResult2_g673 , 0.0 ) ) ) , float4( ase_normWorldNormal , 0.0 ) );
			float DefaultDot14 = dotResult28_g671;
			float temp_output_37_0_g675 = DefaultDot14;
			float temp_output_40_0_g675 = SSSAlpha987;
			float ifLocalVar5_g677 = 0;
			if( temp_output_40_0_g675 >= ( 1.0 - _ShadowLayer1Gate ) )
				ifLocalVar5_g677 = 1.0;
			float lerpResult8_g677 = lerp( 1.0 , ( ( -1.0 + VertexColors441.x + temp_output_37_0_g675 ) - _ShadowLayer1Push ) , ifLocalVar5_g677);
			float ILMG360 = tex2DNode113.g;
			float temp_output_1_0_g674 = ILMG360;
			float temp_output_20_0_g674 = ( 1.0 - ( 0.62 * temp_output_1_0_g674 ) );
			float ILMB117 = tex2DNode113.b;
			float4 color12_g674 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
			float4 temp_cast_12 = (Highlight555).xxxx;
			float4 temp_output_34_0_g674 = temp_cast_12;
			float4 temp_output_22_0_g674 = ( ( ILMB117 * 0.4 ) + ( color12_g674 + temp_output_34_0_g674 ) );
			float4 ifLocalVar24_g674 = 0;
			if( ( ( ( 1.0 - _ILMLayer1 ) * 0.1 ) + 0.9 ) >= temp_output_20_0_g674 )
				ifLocalVar24_g674 = temp_output_22_0_g674;
			float4 clampResult26_g674 = clamp( ifLocalVar24_g674 , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
			float temp_output_44_0_g674 = ( 1.0 - VertexColors441.x );
			float4 color39_g674 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
			float4 temp_output_46_0_g674 = ( ( temp_output_1_0_g674 * 0.4 ) + ( temp_output_34_0_g674 + color39_g674 ) );
			float4 ifLocalVar49_g674 = 0;
			if( _VertexLayer1 >= temp_output_44_0_g674 )
				ifLocalVar49_g674 = temp_output_46_0_g674;
			float4 clampResult51_g674 = clamp( ifLocalVar49_g674 , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
			float temp_output_38_0_g675 = ( clampResult26_g674.r * clampResult51_g674.x );
			float smoothstepResult23_g675 = smoothstep( 0.0 , ( _ShadowLayer1Fuzziness * 0.01 ) , ( lerpResult8_g677 * temp_output_38_0_g675 ));
			float PrimaryDot127_g675 = smoothstepResult23_g675;
			float4 lerpResult26_g675 = lerp( temp_output_42_0_g675 , lerpResult110_g675 , PrimaryDot127_g675);
			float ifLocalVar5_g676 = 0;
			if( temp_output_40_0_g675 >= ( 1.0 - _ShadowLayer2Gate ) )
				ifLocalVar5_g676 = 1.0;
			float lerpResult8_g676 = lerp( 1.0 , ( temp_output_37_0_g675 - _ShadowLayer2Push ) , ifLocalVar5_g676);
			float4 ifLocalVar23_g674 = 0;
			if( ( ( ( 1.0 - _ILMLayer2 ) * 0.1 ) + 0.9 ) >= temp_output_20_0_g674 )
				ifLocalVar23_g674 = temp_output_22_0_g674;
			float4 clampResult25_g674 = clamp( ifLocalVar23_g674 , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
			float4 ifLocalVar50_g674 = 0;
			if( _VertexLayer2 >= temp_output_44_0_g674 )
				ifLocalVar50_g674 = temp_output_46_0_g674;
			float4 clampResult52_g674 = clamp( ifLocalVar50_g674 , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
			float temp_output_39_0_g675 = ( clampResult25_g674.r * clampResult52_g674.x );
			float smoothstepResult25_g675 = smoothstep( 0.0 , ( _ShadowLayer2Fuzziness * 0.01 ) , ( lerpResult8_g676 * temp_output_39_0_g675 ));
			float SecondaryDot129_g675 = smoothstepResult25_g675;
			float4 lerpResult28_g675 = lerp( lerpResult122_g675 , lerpResult26_g675 , SecondaryDot129_g675);
			...
			float4 temp_output_91_0_g675 = SpecularColor924;
			float smoothstepResult82_g675 = smoothstep( 0.0 , ( _SpecularFuzzy * 0.01 ) , ( ( ( 1.0 - ( ( _SpecularSize * 4.0 ) - 2.0 ) ) * -0.2 ) + ( ILMB117 * temp_output_37_0_g675 * temp_output_38_0_g675 * temp_output_39_0_g675 ) ));
			float TertiaryDot131_g675 = smoothstepResult82_g675;
			float4 lerpResult58_g675 = lerp( lerpResult28_g675 , temp_output_91_0_g675 , TertiaryDot131_g675);
			float4 lerpResult142_g675 = lerp( temp_output_42_0_g675 , temp_output_41_0_g675 , PrimaryDot127_g675);
			float4 lerpResult143_g675 = lerp( temp_output_43_0_g675 , lerpResult142_g675 , SecondaryDot129_g675);
			float4 lerpResult144_g675 = lerp( lerpResult143_g675 , temp_output_91_0_g675 , TertiaryDot131_g675);
			float4 lerpResult145_g675 = lerp( ( temp_output_106_0_g675 * lerpResult144_g675 ) , temp_output_111_0_g675 , ( temp_output_97_0_g675 * VertexColors441.x ));
			float4 clampResult33_g675 = clamp( (( FresnelSystem1380 == 0.0 ) ? lerpResult58_g675 :  lerpResult145_g675 ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
			float4 Detail443 = tex2D( _Detail, i.uv2_texcoord2 );
			float4 temp_output_513_0 = ( LightColorOut457 * clampResult33_g675 * Detail443 );
...
/*ASEBEGIN
Version=17800
-1744;69;1691;792;14412.97;5748.764;12.42006;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;1508;-4946.254,-3234.523;Inherit;False;Property;_LightColor;Light Color;0;1;[Enum];Create;True;2;Automatic;0;Forced Fake;1;0;False;0;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1007;-5442.675,121.4663;Inherit;False;Permanent Shadows;-1;;674;1ce4709ce3667c2438e413e9b79be23a;0;8;3;FLOAT;0;False;4;FLOAT;0;False;58;FLOAT;0;False;59;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;57;FLOAT4;0,0,0,0;False;34;FLOAT4;0,0,0,0;False;2;FLOAT;0;FLOAT;35
...
Node;AmplifyShaderEditor.FunctionNode;1520;-1111.61,329.3792;Inherit;False;ASWOutline;-1;;678;ea9f2d47913480c4f9e91454af7efa45;0;10;30;FLOAT;0;False;31;COLOR;0,0,0,0;False;32;FLOAT;0;False;33;FLOAT;0;False;34;COLOR;0,0,0,0;False;35;COLOR;0,0,0,0;False;36;FLOAT;0;False;37;FLOAT;0;False;40;FLOAT;0;False;41;COLOR;0,0,0,0;False;1;FLOAT3;0
...
WireConnection;1630;71;1057;0
WireConnection;1630;46;1016;0
WireConnection;1630;126;1508;0
WireConnection;1630;42;947;0
WireConnection;1630;41;217;0
WireConnection;1630;38;974;0
WireConnection;1630;39;975;0
WireConnection;1630;99;1683;0
WireConnection;1630;100;1122;0
WireConnection;1630;157;1629;0
WireConnection;1630;121;1513;0
...
ASEEND*/
//CHKSM=34DFBC06C4AC3A7BD1A55A4C8BE5D402D15BEADE